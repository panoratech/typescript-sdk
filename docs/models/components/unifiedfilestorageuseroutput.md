...
```typescript
import { UnifiedFilestorageUserOutput } from "@panora/sdk/models/components";

let value: UnifiedFilestorageUserOutput = {
    name: "Joe Doe",
...
| `isMe`                                                                                        | *boolean*                                                                                     | :heavy_check_mark:                                                                            | Whether the user is the one who linked this account.                                          | true                                                                                          |
