...
```typescript
import { PanoraCore } from "@panora/sdk/core.js";
import { syncUpdatePullFrequency } from "@panora/sdk/funcs/syncUpdatePullFrequency.js";
...
```typescript
import { PanoraCore } from "@panora/sdk/core.js";
import { syncGetPullFrequency } from "@panora/sdk/funcs/syncGetPullFrequency.js";
...
async function run() {
  const res = await syncGetPullFrequency(panora);
...
**Promise\<[components.UpdatePullFrequencyDto](../../models/components/updatepullfrequencydto.md)\>**
