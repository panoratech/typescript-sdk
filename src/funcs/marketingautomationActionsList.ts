 ...
 * List Actions
 */
export async function marketingautomationActionsList(
    client$: PanoraCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListMarketingautomationActionRequest$outboundSchema.parse(value$),
    ...
    > => {
        ...
        return () =>
            marketingautomationActionsList(
                client$,
                {
                    ...input$,
                    cursor: nextCursor,
