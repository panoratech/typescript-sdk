...
export async function ecommerceCustomersList(
    ...
    PageIterator<
        Result<
            operations.ListEcommerceCustomersResponse,
            | SDKError
            | SDKValidationError
            | UnexpectedClientError
            | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListEcommerceCustomersRequest$outboundSchema.parse(value$),
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListEcommerceCustomersResponse$inboundSchema, { key: "Result" }),
        m$.fail(["4XX", "5XX"])
