 ...
 */
export async function atsInterviewsCreate(
  client$: PanoraCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.CreateAtsInterviewRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.UnifiedAtsInterviewInput, {
    explode: true,
  });
