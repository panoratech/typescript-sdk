 ...
 * List Users
 */
export async function filestorageUsersList(
    client$: PanoraCore,
    ...
    PageIterator<
        Result<
            operations.ListFilestorageUsersResponse,
            | SDKError
            | SDKValidationError
            | UnexpectedClientError
            | InvalidRequestError
...
> {
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListFilestorageUsersResponse$inboundSchema, { key: "Result" }),
        m$.fail(["4XX", "5XX"])
