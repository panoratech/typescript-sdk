 ...
 * List  Accounts
 */
export async function ticketingAccountsList(
  client: PanoraCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListTicketingAccountRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListTicketingAccountResponse$inboundSchema, {
      key: "Result",
    }),
    M.fail(["4XX", "5XX"]),
