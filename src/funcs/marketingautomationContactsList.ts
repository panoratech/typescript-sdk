 ...
 * List  Contacts
 */
export async function marketingautomationContactsList(
    client$: PanoraCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListMarketingAutomationContactsRequest$outboundSchema.parse(value$),
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListMarketingAutomationContactsResponse$inboundSchema, {
            key: "Result",
        }),
        m$.fail(["4XX", "5XX"])
    ...
    > => {
        ...
        return () =>
            marketingautomationContactsList(
                client$,
                {
                    ...input$,
                    cursor: nextCursor,
