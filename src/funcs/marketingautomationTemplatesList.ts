 ...
 * List Templates
 */
export async function marketingautomationTemplatesList(
    client$: PanoraCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListMarketingautomationTemplatesRequest$outboundSchema.parse(value$),
    ...
    > => {
        ...
        return () =>
            marketingautomationTemplatesList(
                client$,
                {
                    ...input$,
                    cursor: nextCursor,
