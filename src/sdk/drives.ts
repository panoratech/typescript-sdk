...
export class Drives extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/filestorage/drives")();
        ...
        const [result$, raw$] = await m$.match<
            operations.ListFilestorageDrivesResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListFilestorageDrivesResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListFilestorageDrivesResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/filestorage/drives/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedFilestorageDriveOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedFilestorageDriveOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
