...
export class Jobinterviewstage extends ClientSDK {
    ...
    async list(
        ...
        const [result$] = await this.matcher<operations.ListAtsJobInterviewStageResponse>()
            .json(200, operations.ListAtsJobInterviewStageResponse$, { key: "object" })
            .fail(["4XX", "5XX"])
    ...
    async retrieve(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) =>
                operations.RetrieveAtsJobInterviewStageRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        const [result$] = await this.matcher<operations.RetrieveAtsJobInterviewStageResponse>()
            .json(200, operations.RetrieveAtsJobInterviewStageResponse$, {
