...
export class Stages extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/crm/stages")();
        ...
        const [result$, raw$] = await m$.match<
            operations.ListCrmStagesResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListCrmStagesResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (responseData: unknown): Paginator<operations.ListCrmStagesResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/crm/stages/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedCrmStageOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedCrmStageOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
