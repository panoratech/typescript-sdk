...
export class PanoraTags extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAtsTagsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsTagsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (responseData: unknown): Paginator<operations.ListAtsTagsResponse> => {
