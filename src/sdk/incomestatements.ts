...
export class Incomestatements extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAccountingIncomeStatementResponseBody> {
        const input$ = request;
        ...
        const path$ = pathToFunc("/accounting/incomestatements")();
        ...
        >(
            m$.json(200, operations.ListAccountingIncomeStatementResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/accounting/incomestatements/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingIncomestatementOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
