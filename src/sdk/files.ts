...
export class Files extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListFilestorageFileResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListFilestorageFileResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListFilestorageFileResponse> => {
