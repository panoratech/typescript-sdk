...
export class Emails extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListMarketingautomationEmailsResponseBody> {
        const input$ = request;
        ...
        const path$ = pathToFunc("/marketingautomation/emails")();
        ...
        const [result$] = await m$.match<
            operations.ListMarketingautomationEmailsResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListMarketingautomationEmailsResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/marketingautomation/emails/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedMarketingautomationEmailOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
