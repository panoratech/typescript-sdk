...
export class Cashflowstatements extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAccountingCashflowStatementResponseBody> {
        const input$ = request;
        ...
        const path$ = pathToFunc("/accounting/cashflowstatements")();
        ...
        const [result$] = await m$.match<
            operations.ListAccountingCashflowStatementResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingCashflowStatementResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/accounting/cashflowstatements/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingCashflowstatementOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
