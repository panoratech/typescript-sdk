...
export class PanoraMarketingautomationUsers extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/marketingautomation/users")();
        ...
        >(
            m$.json(200, operations.ListMarketingAutomationUsersResponse$inboundSchema, {
                key: "Result",
            }),
            m$.fail(["4XX", "5XX"])
        ...
        ): Paginator<operations.ListMarketingAutomationUsersResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/marketingautomation/users/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedMarketingautomationUserOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
