...
export class Payments extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAccountingPaymentResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingPaymentResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListAccountingPaymentResponse> => {
