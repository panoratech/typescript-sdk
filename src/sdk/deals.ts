...
export class Deals extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/crm/deals")();
        ...
        >(
            m$.json(200, operations.ListCrmDealsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (responseData: unknown): Paginator<operations.ListCrmDealsResponse> => {
    ...
    async create(
        ...
        const [result$] = await m$.match<
            components.UnifiedCrmDealOutput,
            SDKError | SDKValidationError
        >(
            m$.json(201, components.UnifiedCrmDealOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/crm/deals/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedCrmDealOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
