...
export class Timeoffs extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/hris/timeoffs")();
        ...
        >(
            m$.json(200, operations.ListHrisTimeoffsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListHrisTimeoffsResponse> => {
    ...
    async create(
        ...
        const [result$] = await m$.match<
            components.UnifiedHrisTimeoffOutput,
            SDKError | SDKValidationError
        >(
            m$.json(201, components.UnifiedHrisTimeoffOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/hris/timeoffs/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedHrisTimeoffOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
