...
export class Candidates extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAtsCandidateResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsCandidateResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListAtsCandidateResponse> => {
