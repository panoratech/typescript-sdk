...
export class Addresses extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/accounting/addresses")();
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAccountingAddressResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingAddressResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListAccountingAddressResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/accounting/addresses/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedAccountingAddressOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingAddressOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
