...
export class Users extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListTicketingUsersResponse> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.ListTicketingUsersResponse>()
            .json(200, operations.ListTicketingUsersResponse$inboundSchema, { key: "object" })
            .fail(["4XX", "5XX"])
    ...
    async retrieve(
        ...
        options?: RequestOptions
    ): Promise<operations.RetrieveTicketingUserResponse> {
        const input$ = request;
        ...
        const [result$] = await this.matcher<operations.RetrieveTicketingUserResponse>()
            .json(200, operations.RetrieveTicketingUserResponse$inboundSchema, {
                key: "UnifiedTicketingUserOutput",
            })
            .fail(["4XX", "5XX"])
            .match(response, request$, { extraFields: responseFields$ });
