...
export class Eeocs extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/ats/eeocs")();
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAtsEeocsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsEeocsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (responseData: unknown): Paginator<operations.ListAtsEeocsResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/ats/eeocs/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedAtsEeocsOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAtsEeocsOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
