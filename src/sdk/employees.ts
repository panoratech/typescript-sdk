...
export class Employees extends ClientSDK {
    ...
    async list(
        ...
        const path$ = this.templateURLComponent("/hris/employees")();
        ...
        const context = { operationID: "listHrisEmployee", oAuth2Scopes: [], securitySource: null };
    ...
    async retrieve(
        ...
        const path$ = this.templateURLComponent("/hris/employees/{id}")(pathParams$);
