...
export class Contacts extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListTicketingContactsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListTicketingContactsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListTicketingContactsResponse> => {
