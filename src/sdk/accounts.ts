...
export class Accounts extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListTicketingAccountResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListTicketingAccountResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListTicketingAccountResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
