...
export class Employeepayrollruns extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/hris/employeepayrollruns")();
        ...
        const [result$, raw$] = await m$.match<
            operations.ListHrisEmployeePayrollRunResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListHrisEmployeePayrollRunResponse$inboundSchema, {
                key: "Result",
            }),
            m$.fail(["4XX", "5XX"])
        ...
        ): Paginator<operations.ListHrisEmployeePayrollRunResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/hris/employeepayrollruns/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedHrisEmployeepayrollrunOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
