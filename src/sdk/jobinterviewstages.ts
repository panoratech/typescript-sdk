...
export class Jobinterviewstages extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAtsJobInterviewStageResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsJobInterviewStageResponse$inboundSchema, {
                key: "Result",
            }),
            m$.fail(["4XX", "5XX"])
        ...
        ): Paginator<operations.ListAtsJobInterviewStageResponse> => {
