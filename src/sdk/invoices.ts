...
export class Invoices extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAccountingInvoiceResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingInvoiceResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListAccountingInvoiceResponse> => {
    ...
    async create(
        ...
        const [result$] = await m$.match<
            components.UnifiedAccountingInvoiceOutput,
            SDKError | SDKValidationError
        >(
            m$.json(201, components.UnifiedAccountingInvoiceOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingInvoiceOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
