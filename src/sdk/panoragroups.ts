...
export class PanoraGroups extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListFilestorageGroupResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListFilestorageGroupResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListFilestorageGroupResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/filestorage/groups/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedFilestorageGroupOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
