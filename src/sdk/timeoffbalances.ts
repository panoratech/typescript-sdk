...
export class Timeoffbalances extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListHrisTimeoffbalancesResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListHrisTimeoffbalancesResponse$inboundSchema, {
                key: "Result",
            }),
            m$.fail(["4XX", "5XX"])
        ...
        ): Paginator<operations.ListHrisTimeoffbalancesResponse> => {
