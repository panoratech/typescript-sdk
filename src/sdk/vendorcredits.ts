...
export class Vendorcredits extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAccountingVendorCreditResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListAccountingVendorCreditResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingVendorCreditResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/accounting/vendorcredits/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingVendorcreditOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
