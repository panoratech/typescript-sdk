...
export class Taxrates extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAccountingTaxRateResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingTaxRateResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListAccountingTaxRateResponse> => {
