...
export class PanoraUsers extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListCrmUsersResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListCrmUsersResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (responseData: unknown): Paginator<operations.ListCrmUsersResponse> => {
    ...
    async retrieve(
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedCrmUserOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
