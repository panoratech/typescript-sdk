...
export class Bankinfos extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/hris/bankinfos")();
        ...
        const [result$, raw$] = await m$.match<
            operations.ListHrisBankInfoResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListHrisBankInfoResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListHrisBankInfoResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/hris/bankinfos/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedHrisBankinfoOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedHrisBankinfoOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
