...
export class Comments extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListTicketingCommentsResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListTicketingCommentsResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListTicketingCommentsResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
