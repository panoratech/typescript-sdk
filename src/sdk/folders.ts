...
export class Folders extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListFilestorageFolderResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListFilestorageFolderResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListFilestorageFolderResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
