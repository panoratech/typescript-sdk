...
export class Folders extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListFilestorageFolderResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListFilestorageFolderResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListFilestorageFolderResponse> => {
