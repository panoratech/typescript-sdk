...
export class Rejectreasons extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAtsRejectReasonsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsRejectReasonsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListAtsRejectReasonsResponse> => {
