...
export class Journalentries extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAccountingJournalEntryResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListAccountingJournalEntryResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingJournalEntryResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async create(
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(201, components.UnifiedAccountingJournalentryOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/accounting/journalentries/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingJournalentryOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
