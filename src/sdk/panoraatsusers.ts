...
export class PanoraAtsUsers extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAtsUsersResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsUsersResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (responseData: unknown): Paginator<operations.ListAtsUsersResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/ats/users/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedAtsUserOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAtsUserOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
