...
export class Employerbenefits extends ClientSDK {
    ...
    async list(
        ...
        const parsed$ = schemas$.safeParse(
            input$,
            (value$) => operations.ListHrisEmployerBenefitsRequest$outboundSchema.parse(value$),
        ...
        const [result$, raw$] = await m$.match<
            operations.ListHrisEmployerBenefitsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListHrisEmployerBenefitsResponse$inboundSchema, {
                key: "Result",
            }),
            m$.fail(["4XX", "5XX"])
        ...
        ): Paginator<operations.ListHrisEmployerBenefitsResponse> => {
