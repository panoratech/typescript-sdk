...
export class Interviews extends ClientSDK {
    ...
    async list(
        ...
        const path$ = this.templateURLComponent("/ats/interviews")();
        ...
        const context = { operationID: "listAtsInterview", oAuth2Scopes: [], securitySource: null };
        ...
        const [result$] = await this.matcher<operations.ListAtsInterviewResponse>()
            .json(200, operations.ListAtsInterviewResponse$inboundSchema, { key: "object" })
            .fail(["4XX", "5XX"])
    ...
    async create(
        ...
        const [result$] = await this.matcher<operations.CreateAtsInterviewResponse>()
            .json(201, operations.CreateAtsInterviewResponse$inboundSchema, {
    ...
    async retrieve(
        ...
        const path$ = this.templateURLComponent("/ats/interviews/{id}")(pathParams$);
        ...
        const [result$] = await this.matcher<operations.RetrieveAtsInterviewResponse>()
            .json(200, operations.RetrieveAtsInterviewResponse$inboundSchema, {
                key: "UnifiedAtsInterviewOutput",
            })
            .fail(["4XX", "5XX"])
            .match(response, request$, { extraFields: responseFields$ });
