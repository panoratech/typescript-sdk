...
export class Balancesheets extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAccountingBalanceSheetsResponseBody> {
        const input$ = request;
        ...
        const path$ = pathToFunc("/accounting/balancesheets")();
        ...
        const [result$] = await m$.match<
            operations.ListAccountingBalanceSheetsResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingBalanceSheetsResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/accounting/balancesheets/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingBalancesheetOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
