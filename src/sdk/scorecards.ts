...
export class Scorecards extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAtsScorecardResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListAtsScorecardResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsScorecardResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/ats/scorecards/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAtsScorecardOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
