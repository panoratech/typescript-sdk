...
export class Attachments extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListAtsAttachmentResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsAttachmentResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListAtsAttachmentResponse> => {
    ...
    async create(
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(201, components.UnifiedAtsAttachmentOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/ats/attachments/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAtsAttachmentOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
