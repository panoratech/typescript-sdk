...
export class Attachments extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAtsAttachmentResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListAtsAttachmentResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAtsAttachmentResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
