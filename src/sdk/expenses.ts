...
export class Expenses extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAccountingExpenseResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListAccountingExpenseResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingExpenseResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
