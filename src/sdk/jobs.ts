...
export class Jobs extends ClientSDK {
    ...
    async list(
        ...
        const path$ = this.templateURLComponent("/ats/jobs")();
        ...
        const context = { operationID: "listAtsJob", oAuth2Scopes: [], securitySource: null };
    ...
    async retrieve(
        ...
        const path$ = this.templateURLComponent("/ats/jobs/{id}")(pathParams$);
        ...
        const context = { operationID: "retrieveAtsJob", oAuth2Scopes: [], securitySource: null };
