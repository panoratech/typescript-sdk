...
export class Messages extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListMarketingautomationMessagesResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListMarketingautomationMessagesResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListMarketingautomationMessagesResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/marketingautomation/messages/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedMarketingautomationMessageOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
