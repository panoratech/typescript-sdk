...
export class Events extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListMarketingAutomationEventsResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListMarketingAutomationEventsResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListMarketingAutomationEventsResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/marketingautomation/events/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedMarketingautomationEventOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
