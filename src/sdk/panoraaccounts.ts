...
export class PanoraAccounts extends ClientSDK {
    ...
    async list(
    ...
    ): Promise<operations.ListAccountingAccountsResponseBody> {
        const input$ = request;
        ...
        const [result$] = await m$.match<
            operations.ListAccountingAccountsResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListAccountingAccountsResponseBody$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async create(
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(201, components.UnifiedAccountingAccountOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/accounting/accounts/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            ...
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedAccountingAccountOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
