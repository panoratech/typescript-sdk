...
export class Teams extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListTicketingTeamsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListTicketingTeamsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListTicketingTeamsResponse> => {
