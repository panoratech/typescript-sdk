...
export class Dependents extends ClientSDK {
    ...
    async list(
        ...
        const path$ = pathToFunc("/hris/dependents")();
        ...
        const [result$, raw$] = await m$.match<
            operations.ListHrisDependentsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListHrisDependentsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListHrisDependentsResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/hris/dependents/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedHrisDependentOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedHrisDependentOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
