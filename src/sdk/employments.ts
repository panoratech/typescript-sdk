...
export class Employments extends ClientSDK {
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.ListHrisEmploymentsResponse,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.ListHrisEmploymentsResponse$inboundSchema, { key: "Result" }),
            m$.fail(["4XX", "5XX"])
        )(response, { extraFields: responseFields$ });

        const nextFunc = (
            responseData: unknown
        ): Paginator<operations.ListHrisEmploymentsResponse> => {
    ...
    async retrieve(
        ...
        const path$ = pathToFunc("/hris/employments/{id}")(pathParams$);
        ...
        const [result$] = await m$.match<
            components.UnifiedHrisEmploymentOutput,
            SDKError | SDKValidationError
        >(
            m$.json(200, components.UnifiedHrisEmploymentOutput$inboundSchema),
            m$.fail(["4XX", "5XX"])
        )(response);
