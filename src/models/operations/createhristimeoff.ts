...
export namespace CreateHrisTimeoffRequest$ {
    export const inboundSchema: z.ZodType<CreateHrisTimeoffRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateHrisTimeoffRequest> = z
        .object({
...
export namespace CreateHrisTimeoffResponse$ {
    export const inboundSchema: z.ZodType<CreateHrisTimeoffResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateHrisTimeoffResponse> = z
        .object({
