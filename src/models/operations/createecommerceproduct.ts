...
> = z
    .object({
        ...
        UnifiedEcommerceProductInput: components.UnifiedEcommerceProductInput$inboundSchema,
    })
    .transform((v) => {
        return remap$(v, {
...
export type CreateEcommerceProductRequest$Outbound = {
    ...
    UnifiedEcommerceProductInput: components.UnifiedEcommerceProductInput$Outbound;
};
...
> = z
    .object({
        ...
        unifiedEcommerceProductInput: components.UnifiedEcommerceProductInput$outboundSchema,
    })
    .transform((v) => {
        return remap$(v, {
