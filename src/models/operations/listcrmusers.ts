...
export namespace ListCrmUsersRequest$ {
    export const inboundSchema: z.ZodType<ListCrmUsersRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCrmUsersRequest> = z
        .object({
...
export namespace ListCrmUsersResponseBody$ {
    export const inboundSchema: z.ZodType<ListCrmUsersResponseBody, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCrmUsersResponseBody> = z
        .object({
            prevCursor: z.string(),
            nextCursor: z.string(),
...
export namespace ListCrmUsersResponse$ {
    export const inboundSchema: z.ZodType<ListCrmUsersResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCrmUsersResponse> = z
        .object({
