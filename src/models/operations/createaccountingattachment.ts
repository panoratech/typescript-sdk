...
export function createAccountingAttachmentRequestToJSON(
  createAccountingAttachmentRequest: CreateAccountingAttachmentRequest,
): string {
  return JSON.stringify(
    CreateAccountingAttachmentRequest$outboundSchema.parse(
      createAccountingAttachmentRequest,
    ),
  );
}

export function createAccountingAttachmentRequestFromJSON(
  jsonString: string,
): SafeParseResult<CreateAccountingAttachmentRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateAccountingAttachmentRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateAccountingAttachmentRequest' from JSON`,
  );
}
