...
export function createAccountingJournalEntryRequestToJSON(
  createAccountingJournalEntryRequest: CreateAccountingJournalEntryRequest,
): string {
  return JSON.stringify(
    CreateAccountingJournalEntryRequest$outboundSchema.parse(
      createAccountingJournalEntryRequest,
    ),
  );
}

export function createAccountingJournalEntryRequestFromJSON(
  jsonString: string,
): SafeParseResult<CreateAccountingJournalEntryRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CreateAccountingJournalEntryRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateAccountingJournalEntryRequest' from JSON`,
  );
}
