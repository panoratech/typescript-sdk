...
export namespace ListCrmEngagementsRequest$ {
    export const inboundSchema: z.ZodType<ListCrmEngagementsRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCrmEngagementsRequest> = z
        .object({
...
export namespace ListCrmEngagementsResponseBody$ {
    export const inboundSchema: z.ZodType<ListCrmEngagementsResponseBody, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCrmEngagementsResponseBody> =
        z
            .object({
                prevCursor: z.string(),
                nextCursor: z.string(),
...
export namespace ListCrmEngagementsResponse$ {
    export const inboundSchema: z.ZodType<ListCrmEngagementsResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCrmEngagementsResponse> = z
        .object({
