...
export type CreateMarketingAutomationContactRequest = {
  ...
  unifiedMarketingautomationContactInput:
    components.UnifiedMarketingautomationContactInput;
};
...
export type CreateMarketingAutomationContactRequest$Outbound = {
  ...
  UnifiedMarketingautomationContactInput:
    components.UnifiedMarketingautomationContactInput$Outbound;
};
...
export namespace CreateMarketingAutomationContactRequest$ {
  ...
  export const inboundSchema =
    CreateMarketingAutomationContactRequest$inboundSchema;
  /** @deprecated use `CreateMarketingAutomationContactRequest$outboundSchema` instead. */
  export const outboundSchema =
    CreateMarketingAutomationContactRequest$outboundSchema;
...
export function createMarketingAutomationContactRequestToJSON(
  createMarketingAutomationContactRequest:
    CreateMarketingAutomationContactRequest,
): string {
  return JSON.stringify(
    CreateMarketingAutomationContactRequest$outboundSchema.parse(
      createMarketingAutomationContactRequest,
    ),
  );
}

export function createMarketingAutomationContactRequestFromJSON(
  jsonString: string,
): SafeParseResult<
  CreateMarketingAutomationContactRequest,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CreateMarketingAutomationContactRequest$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CreateMarketingAutomationContactRequest' from JSON`,
  );
}
