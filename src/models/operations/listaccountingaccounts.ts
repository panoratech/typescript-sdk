...
export namespace ListAccountingAccountsRequest$ {
    export const inboundSchema: z.ZodType<ListAccountingAccountsRequest, z.ZodTypeDef, unknown> = z
        .object({
...
export namespace ListAccountingAccountsResponse$ {
    export const inboundSchema: z.ZodType<ListAccountingAccountsResponse, z.ZodTypeDef, unknown> = z
        .object({
