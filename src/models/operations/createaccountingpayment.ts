...
export namespace CreateAccountingPaymentRequest$ {
    export const inboundSchema: z.ZodType<CreateAccountingPaymentRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateAccountingPaymentRequest> =
        z
            .object({
...
export namespace CreateAccountingPaymentResponse$ {
    export const inboundSchema: z.ZodType<CreateAccountingPaymentResponse, z.ZodTypeDef, unknown> =
        z
            .object({
