...
export namespace RetrieveAtsOfferRequest$ {
    export const inboundSchema: z.ZodType<RetrieveAtsOfferRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RetrieveAtsOfferRequest> = z
        .object({
...
export namespace RetrieveAtsOfferResponse$ {
    export const inboundSchema: z.ZodType<RetrieveAtsOfferResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RetrieveAtsOfferResponse> = z
        .object({
