...
export namespace RetrieveAtsApplicationRequest$ {
    export const inboundSchema: z.ZodType<RetrieveAtsApplicationRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RetrieveAtsApplicationRequest> =
        z
            .object({
...
export namespace RetrieveAtsApplicationResponse$ {
    export const inboundSchema: z.ZodType<RetrieveAtsApplicationResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RetrieveAtsApplicationResponse> =
        z
            .object({
