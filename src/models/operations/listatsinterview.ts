...
export namespace ListAtsInterviewRequest$ {
    export const inboundSchema: z.ZodType<ListAtsInterviewRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListAtsInterviewRequest> = z
        .object({
...
export namespace ListAtsInterviewResponseBody$ {
    export const inboundSchema: z.ZodType<ListAtsInterviewResponseBody, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListAtsInterviewResponseBody> = z
        .object({
            prevCursor: z.string(),
            nextCursor: z.string(),
...
export namespace ListAtsInterviewResponse$ {
    export const inboundSchema: z.ZodType<ListAtsInterviewResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListAtsInterviewResponse> = z
        .object({
