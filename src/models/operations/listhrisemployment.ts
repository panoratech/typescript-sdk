...
export namespace ListHrisEmploymentRequest$ {
    export const inboundSchema: z.ZodType<ListHrisEmploymentRequest, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListHrisEmploymentRequest> = z
        .object({
...
export namespace ListHrisEmploymentResponseBody$ {
    export const inboundSchema: z.ZodType<ListHrisEmploymentResponseBody, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListHrisEmploymentResponseBody> =
        z
            .object({
                prevCursor: z.string(),
                nextCursor: z.string(),
...
export namespace ListHrisEmploymentResponse$ {
    export const inboundSchema: z.ZodType<ListHrisEmploymentResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListHrisEmploymentResponse> = z
        .object({
