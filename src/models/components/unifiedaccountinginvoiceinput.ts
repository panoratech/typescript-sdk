 ...
 */
export enum UnifiedAccountingInvoiceInputCurrency {
    Aed = "AED",
    Afn = "AFN",
    All = "ALL",
    Amd = "AMD",
...
export type UnifiedAccountingInvoiceInput = {
     ...
     * The currency of the invoice
     */
    currency?: UnifiedAccountingInvoiceInputCurrency | null | undefined;
    /**
...
/** @internal */
export const UnifiedAccountingInvoiceInputCurrency$inboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingInvoiceInputCurrency
> = z.nativeEnum(UnifiedAccountingInvoiceInputCurrency);

/** @internal */
export const UnifiedAccountingInvoiceInputCurrency$outboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingInvoiceInputCurrency
> = UnifiedAccountingInvoiceInputCurrency$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UnifiedAccountingInvoiceInputCurrency$ {
    /** @deprecated use `UnifiedAccountingInvoiceInputCurrency$inboundSchema` instead. */
    export const inboundSchema = UnifiedAccountingInvoiceInputCurrency$inboundSchema;
    /** @deprecated use `UnifiedAccountingInvoiceInputCurrency$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingInvoiceInputCurrency$outboundSchema;
}
...
> = z
    .object({
        ...
        currency: z.nullable(UnifiedAccountingInvoiceInputCurrency$inboundSchema).optional(),
...
> = z
    .object({
        ...
        memo: z.nullable(z.string()).optional(),
        currency: z.nullable(UnifiedAccountingInvoiceInputCurrency$outboundSchema).optional(),
