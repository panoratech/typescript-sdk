 ...
 */
export enum UnifiedAccountingPaymentOutputCurrency {
    Aed = "AED",
    Afn = "AFN",
    All = "ALL",
    Amd = "AMD",
...
export type UnifiedAccountingPaymentOutput = {
     ...
     * The currency of the payment
     */
    currency?: UnifiedAccountingPaymentOutputCurrency | null | undefined;
    /**
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedAccountingPaymentOutputFieldMappings | null | undefined;
    /**
...
/** @internal */
export const UnifiedAccountingPaymentOutputCurrency$inboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingPaymentOutputCurrency
> = z.nativeEnum(UnifiedAccountingPaymentOutputCurrency);

/** @internal */
export const UnifiedAccountingPaymentOutputCurrency$outboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingPaymentOutputCurrency
> = UnifiedAccountingPaymentOutputCurrency$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UnifiedAccountingPaymentOutputCurrency$ {
    /** @deprecated use `UnifiedAccountingPaymentOutputCurrency$inboundSchema` instead. */
    export const inboundSchema = UnifiedAccountingPaymentOutputCurrency$inboundSchema;
    /** @deprecated use `UnifiedAccountingPaymentOutputCurrency$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingPaymentOutputCurrency$outboundSchema;
}

/** @internal */
export const UnifiedAccountingPaymentOutputFieldMappings$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedAccountingPaymentOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedAccountingPaymentOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedAccountingPaymentOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedAccountingPaymentOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingPaymentOutputFieldMappings$outboundSchema;
...
export namespace UnifiedAccountingPaymentOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedAccountingPaymentOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedAccountingPaymentOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingPaymentOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        currency: z.nullable(UnifiedAccountingPaymentOutputCurrency$inboundSchema).optional(),
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedAccountingPaymentOutputFieldMappings$inboundSchema))
            .optional(),
        ...
        remote_updated_at: z
            ...
            .optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedAccountingPaymentOutputRemoteData$inboundSchema))
            .optional(),
        created_at: z
            .nullable(
                z
...
export type UnifiedAccountingPaymentOutput$Outbound = {
    ...
    field_mappings?: UnifiedAccountingPaymentOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
    remote_id?: string | null | undefined;
    remote_updated_at?: string | null | undefined;
    remote_data?: UnifiedAccountingPaymentOutputRemoteData$Outbound | null | undefined;
...
> = z
    .object({
        ...
        currency: z.nullable(UnifiedAccountingPaymentOutputCurrency$outboundSchema).optional(),
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedAccountingPaymentOutputFieldMappings$outboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remoteId: z.nullable(z.string()).optional(),
        remoteUpdatedAt: z.nullable(z.date().transform((v) => v.toISOString())).optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedAccountingPaymentOutputRemoteData$outboundSchema))
            .optional(),
