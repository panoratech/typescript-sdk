...
export const Users$inboundSchema: z.ZodType<Users, z.ZodTypeDef, unknown> = z
  .union([UnifiedFilestorageUserOutput$inboundSchema, z.string()]);
...
export const Users$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  Users
> = z.union([UnifiedFilestorageUserOutput$outboundSchema, z.string()]);
...
> = z.object({
  ...
  users: z.array(
    z.union([UnifiedFilestorageUserOutput$inboundSchema, z.string()]),
  ),
