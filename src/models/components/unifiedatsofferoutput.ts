...
> = z.object({
  ...
  created_at: z.nullable(
    z.lazy(() => UnifiedAtsOfferOutputCreatedAt$inboundSchema),
  ).optional(),
  modified_at: z.nullable(
    z.lazy(() => UnifiedAtsOfferOutputModifiedAt$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  createdAt: z.nullable(
    z.lazy(() => UnifiedAtsOfferOutputCreatedAt$outboundSchema),
  ).optional(),
  modifiedAt: z.nullable(
    z.lazy(() => UnifiedAtsOfferOutputModifiedAt$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
