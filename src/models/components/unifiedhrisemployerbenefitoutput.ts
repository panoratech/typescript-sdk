...
export type UnifiedHrisEmployerbenefitOutput = {
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedHrisEmployerbenefitOutputFieldMappings | null | undefined;
    /**
...
/** @internal */
export const UnifiedHrisEmployerbenefitOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisEmployerbenefitOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedHrisEmployerbenefitOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedHrisEmployerbenefitOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisEmployerbenefitOutputFieldMappings$outboundSchema;
...
/** @internal */
export const UnifiedHrisEmployerbenefitOutputRemoteData$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedHrisEmployerbenefitOutputRemoteData$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisEmployerbenefitOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedHrisEmployerbenefitOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedHrisEmployerbenefitOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisEmployerbenefitOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedHrisEmployerbenefitOutputFieldMappings$inboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remote_id: z.nullable(z.string()).optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedHrisEmployerbenefitOutputRemoteData$inboundSchema))
            .optional(),
        remote_created_at: z
            .nullable(
                z
...
export type UnifiedHrisEmployerbenefitOutput$Outbound = {
    ...
    field_mappings?: UnifiedHrisEmployerbenefitOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
    remote_id?: string | null | undefined;
    remote_data?: UnifiedHrisEmployerbenefitOutputRemoteData$Outbound | null | undefined;
...
> = z
    .object({
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedHrisEmployerbenefitOutputFieldMappings$outboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remoteId: z.nullable(z.string()).optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedHrisEmployerbenefitOutputRemoteData$outboundSchema))
            .optional(),
