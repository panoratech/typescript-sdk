...
export namespace UnifiedHrisEmployeeOutputFieldMappings$ {
  ...
  export const inboundSchema =
    UnifiedHrisEmployeeOutputFieldMappings$inboundSchema;
  /** @deprecated use `UnifiedHrisEmployeeOutputFieldMappings$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedHrisEmployeeOutputFieldMappings$outboundSchema;
...
export namespace UnifiedHrisEmployeeOutputRemoteData$ {
  ...
  export const inboundSchema =
    UnifiedHrisEmployeeOutputRemoteData$inboundSchema;
  /** @deprecated use `UnifiedHrisEmployeeOutputRemoteData$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedHrisEmployeeOutputRemoteData$outboundSchema;
...
> = z.object({
  ...
  field_mappings: z.nullable(
    z.lazy(() => UnifiedHrisEmployeeOutputFieldMappings$inboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remote_id: z.nullable(z.string()).optional(),
  remote_data: z.nullable(
    z.lazy(() => UnifiedHrisEmployeeOutputRemoteData$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  fieldMappings: z.nullable(
    z.lazy(() => UnifiedHrisEmployeeOutputFieldMappings$outboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remoteId: z.nullable(z.string()).optional(),
  remoteData: z.nullable(
    z.lazy(() => UnifiedHrisEmployeeOutputRemoteData$outboundSchema),
  ).optional(),
