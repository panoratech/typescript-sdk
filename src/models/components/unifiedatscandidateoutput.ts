...
export type UnifiedAtsCandidateOutputAttachments =
  | UnifiedAtsAttachmentOutput
  | string;
...
export namespace UnifiedAtsCandidateOutputAttachments$ {
  ...
  export const inboundSchema =
    UnifiedAtsCandidateOutputAttachments$inboundSchema;
  /** @deprecated use `UnifiedAtsCandidateOutputAttachments$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedAtsCandidateOutputAttachments$outboundSchema;
...
/** @internal */
export type UnifiedAtsCandidateOutputTags$Outbound =
  | UnifiedAtsTagOutput$Outbound
  | string;
