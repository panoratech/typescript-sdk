...
export namespace UnifiedHrisCompanyOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedHrisCompanyOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedHrisCompanyOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisCompanyOutputFieldMappings$outboundSchema;
...
export namespace UnifiedHrisCompanyOutputRemoteData$ {
    ...
    export const outboundSchema = UnifiedHrisCompanyOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedHrisCompanyOutputFieldMappings$inboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remote_id: z.nullable(z.string()).optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedHrisCompanyOutputRemoteData$inboundSchema))
            .optional(),
        remote_created_at: z
            .nullable(
                z
...
export type UnifiedHrisCompanyOutput$Outbound = {
    ...
    eins?: Array<string> | null | undefined;
    field_mappings?: UnifiedHrisCompanyOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
...
> = z
    .object({
        ...
        eins: z.nullable(z.array(z.string())).optional(),
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedHrisCompanyOutputFieldMappings$outboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remoteId: z.nullable(z.string()).optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedHrisCompanyOutputRemoteData$outboundSchema))
            .optional(),
