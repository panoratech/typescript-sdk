...
export namespace UnifiedHrisGroupOutputFieldMappings$ {
  ...
  export const inboundSchema =
    UnifiedHrisGroupOutputFieldMappings$inboundSchema;
  /** @deprecated use `UnifiedHrisGroupOutputFieldMappings$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedHrisGroupOutputFieldMappings$outboundSchema;
...
> = z.object({
  ...
  field_mappings: z.nullable(
    z.lazy(() => UnifiedHrisGroupOutputFieldMappings$inboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remote_id: z.nullable(z.string()).optional(),
  remote_data: z.nullable(
    z.lazy(() => UnifiedHrisGroupOutputRemoteData$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  fieldMappings: z.nullable(
    z.lazy(() => UnifiedHrisGroupOutputFieldMappings$outboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remoteId: z.nullable(z.string()).optional(),
  remoteData: z.nullable(
    z.lazy(() => UnifiedHrisGroupOutputRemoteData$outboundSchema),
  ).optional(),
