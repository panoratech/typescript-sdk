...
export namespace UnifiedHrisEmployeeInputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedHrisEmployeeInputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedHrisEmployeeInputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisEmployeeInputFieldMappings$outboundSchema;
...
> = z
    .object({
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedHrisEmployeeInputFieldMappings$inboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
export type UnifiedHrisEmployeeInput$Outbound = {
    ...
    field_mappings?: UnifiedHrisEmployeeInputFieldMappings$Outbound | null | undefined;
};
...
> = z
    .object({
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedHrisEmployeeInputFieldMappings$outboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
