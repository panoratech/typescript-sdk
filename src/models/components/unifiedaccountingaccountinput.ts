...
/** @internal */
export const UnifiedAccountingAccountInputFieldMappings$inboundSchema:
  z.ZodType<UnifiedAccountingAccountInputFieldMappings, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const UnifiedAccountingAccountInputFieldMappings$outboundSchema:
  z.ZodType<
...
export namespace UnifiedAccountingAccountInputFieldMappings$ {
  ...
  export const inboundSchema =
    UnifiedAccountingAccountInputFieldMappings$inboundSchema;
...
> = z.object({
  ...
  field_mappings: z.nullable(
    z.lazy(() => UnifiedAccountingAccountInputFieldMappings$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  fieldMappings: z.nullable(
    z.lazy(() => UnifiedAccountingAccountInputFieldMappings$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
