...
export namespace UnifiedMarketingautomationEmailOutput$ {
    ...
    export const inboundSchema = UnifiedMarketingautomationEmailOutput$inboundSchema;
    /** @deprecated use `UnifiedMarketingautomationEmailOutput$outboundSchema` instead. */
    export const outboundSchema = UnifiedMarketingautomationEmailOutput$outboundSchema;
