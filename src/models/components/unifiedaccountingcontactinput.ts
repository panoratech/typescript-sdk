...
/** @internal */
export const UnifiedAccountingContactInputFieldMappings$inboundSchema:
  z.ZodType<UnifiedAccountingContactInputFieldMappings, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const UnifiedAccountingContactInputFieldMappings$outboundSchema:
  z.ZodType<
...
export namespace UnifiedAccountingContactInputFieldMappings$ {
  ...
  export const inboundSchema =
    UnifiedAccountingContactInputFieldMappings$inboundSchema;
...
> = z.object({
  ...
  field_mappings: z.nullable(
    z.lazy(() => UnifiedAccountingContactInputFieldMappings$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  fieldMappings: z.nullable(
    z.lazy(() => UnifiedAccountingContactInputFieldMappings$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
