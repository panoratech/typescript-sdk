...
export namespace UnifiedAtsInterviewInput$ {
    export const inboundSchema: z.ZodType<UnifiedAtsInterviewInput, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UnifiedAtsInterviewInput> = z
        .object({
            status: z.string().optional(),
