...
export type UnifiedHrisEmployeepayrollrunOutput = {
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedHrisEmployeepayrollrunOutputFieldMappings | null | undefined;
    /**
...
/** @internal */
export const UnifiedHrisEmployeepayrollrunOutputFieldMappings$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedHrisEmployeepayrollrunOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisEmployeepayrollrunOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedHrisEmployeepayrollrunOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedHrisEmployeepayrollrunOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisEmployeepayrollrunOutputFieldMappings$outboundSchema;
    /** @deprecated use `UnifiedHrisEmployeepayrollrunOutputFieldMappings$Outbound` instead. */
    export type Outbound = UnifiedHrisEmployeepayrollrunOutputFieldMappings$Outbound;
}

/** @internal */
export const UnifiedHrisEmployeepayrollrunOutputRemoteData$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedHrisEmployeepayrollrunOutputRemoteData$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisEmployeepayrollrunOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedHrisEmployeepayrollrunOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedHrisEmployeepayrollrunOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisEmployeepayrollrunOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedHrisEmployeepayrollrunOutputFieldMappings$inboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remote_id: z.nullable(z.string()).optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedHrisEmployeepayrollrunOutputRemoteData$inboundSchema))
            .optional(),
        remote_created_at: z
            .nullable(
                z
...
export type UnifiedHrisEmployeepayrollrunOutput$Outbound = {
    ...
    field_mappings?: UnifiedHrisEmployeepayrollrunOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
    remote_id?: string | null | undefined;
    remote_data?: UnifiedHrisEmployeepayrollrunOutputRemoteData$Outbound | null | undefined;
...
> = z
    .object({
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedHrisEmployeepayrollrunOutputFieldMappings$outboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remoteId: z.nullable(z.string()).optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedHrisEmployeepayrollrunOutputRemoteData$outboundSchema))
            .optional(),
