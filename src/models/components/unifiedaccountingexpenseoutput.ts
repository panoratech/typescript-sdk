 ...
 */
export enum UnifiedAccountingExpenseOutputCurrency {
    Aed = "AED",
    Afn = "AFN",
    All = "ALL",
    Amd = "AMD",
...
export type UnifiedAccountingExpenseOutput = {
     ...
     * The currency of the expense
     */
    currency?: UnifiedAccountingExpenseOutputCurrency | null | undefined;
    /**
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedAccountingExpenseOutputFieldMappings | null | undefined;
    /**
...
/** @internal */
export const UnifiedAccountingExpenseOutputCurrency$inboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingExpenseOutputCurrency
> = z.nativeEnum(UnifiedAccountingExpenseOutputCurrency);

/** @internal */
export const UnifiedAccountingExpenseOutputCurrency$outboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingExpenseOutputCurrency
> = UnifiedAccountingExpenseOutputCurrency$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UnifiedAccountingExpenseOutputCurrency$ {
    /** @deprecated use `UnifiedAccountingExpenseOutputCurrency$inboundSchema` instead. */
    export const inboundSchema = UnifiedAccountingExpenseOutputCurrency$inboundSchema;
    /** @deprecated use `UnifiedAccountingExpenseOutputCurrency$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingExpenseOutputCurrency$outboundSchema;
}

/** @internal */
export const UnifiedAccountingExpenseOutputFieldMappings$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedAccountingExpenseOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedAccountingExpenseOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedAccountingExpenseOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedAccountingExpenseOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingExpenseOutputFieldMappings$outboundSchema;
...
export namespace UnifiedAccountingExpenseOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedAccountingExpenseOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedAccountingExpenseOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingExpenseOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        currency: z.nullable(UnifiedAccountingExpenseOutputCurrency$inboundSchema).optional(),
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedAccountingExpenseOutputFieldMappings$inboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remote_id: z.nullable(z.string()).optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedAccountingExpenseOutputRemoteData$inboundSchema))
            .optional(),
        remote_created_at: z
            .nullable(
                z
...
export type UnifiedAccountingExpenseOutput$Outbound = {
    ...
    field_mappings?: UnifiedAccountingExpenseOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
    remote_id?: string | null | undefined;
    remote_data?: UnifiedAccountingExpenseOutputRemoteData$Outbound | null | undefined;
...
> = z
    .object({
        ...
        currency: z.nullable(UnifiedAccountingExpenseOutputCurrency$outboundSchema).optional(),
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedAccountingExpenseOutputFieldMappings$outboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remoteId: z.nullable(z.string()).optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedAccountingExpenseOutputRemoteData$outboundSchema))
            .optional(),
