...
export namespace UnifiedHrisTimeoffInputFieldMappings$ {
  ...
  export const inboundSchema =
    UnifiedHrisTimeoffInputFieldMappings$inboundSchema;
  /** @deprecated use `UnifiedHrisTimeoffInputFieldMappings$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedHrisTimeoffInputFieldMappings$outboundSchema;
...
> = z.object({
  ...
  field_mappings: z.nullable(
    z.lazy(() => UnifiedHrisTimeoffInputFieldMappings$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  fieldMappings: z.nullable(
    z.lazy(() => UnifiedHrisTimeoffInputFieldMappings$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
