...
export type UnifiedHrisTimeoffbalanceOutput = {
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedHrisTimeoffbalanceOutputFieldMappings | null | undefined;
    /**
...
/** @internal */
export const UnifiedHrisTimeoffbalanceOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisTimeoffbalanceOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedHrisTimeoffbalanceOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedHrisTimeoffbalanceOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisTimeoffbalanceOutputFieldMappings$outboundSchema;
...
/** @internal */
export const UnifiedHrisTimeoffbalanceOutputRemoteData$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisTimeoffbalanceOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedHrisTimeoffbalanceOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedHrisTimeoffbalanceOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisTimeoffbalanceOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        remote_data: z
            .nullable(z.lazy(() => UnifiedHrisTimeoffbalanceOutputRemoteData$inboundSchema))
            .optional(),
...
export type UnifiedHrisTimeoffbalanceOutput$Outbound = {
    ...
    field_mappings?: UnifiedHrisTimeoffbalanceOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
    remote_id?: string | null | undefined;
    remote_data?: UnifiedHrisTimeoffbalanceOutputRemoteData$Outbound | null | undefined;
...
> = z
    .object({
        ...
        remoteData: z
            .nullable(z.lazy(() => UnifiedHrisTimeoffbalanceOutputRemoteData$outboundSchema))
            .optional(),
