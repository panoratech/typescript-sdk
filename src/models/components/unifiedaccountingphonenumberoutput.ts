...
export type UnifiedAccountingPhonenumberOutput = {
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedAccountingPhonenumberOutputFieldMappings | null | undefined;
    /**
...
/** @internal */
export const UnifiedAccountingPhonenumberOutputFieldMappings$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedAccountingPhonenumberOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedAccountingPhonenumberOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedAccountingPhonenumberOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedAccountingPhonenumberOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingPhonenumberOutputFieldMappings$outboundSchema;
    /** @deprecated use `UnifiedAccountingPhonenumberOutputFieldMappings$Outbound` instead. */
    export type Outbound = UnifiedAccountingPhonenumberOutputFieldMappings$Outbound;
}

/** @internal */
export const UnifiedAccountingPhonenumberOutputRemoteData$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedAccountingPhonenumberOutputRemoteData$outboundSchema: z.ZodType<
...
export namespace UnifiedAccountingPhonenumberOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedAccountingPhonenumberOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedAccountingPhonenumberOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingPhonenumberOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedAccountingPhonenumberOutputFieldMappings$inboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remote_id: z.nullable(z.string()).optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedAccountingPhonenumberOutputRemoteData$inboundSchema))
            .optional(),
        created_at: z
            .nullable(
                z
...
export type UnifiedAccountingPhonenumberOutput$Outbound = {
    ...
    field_mappings?: UnifiedAccountingPhonenumberOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
    remote_id?: string | null | undefined;
    remote_data?: UnifiedAccountingPhonenumberOutputRemoteData$Outbound | null | undefined;
...
> = z
    .object({
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedAccountingPhonenumberOutputFieldMappings$outboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        remoteId: z.nullable(z.string()).optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedAccountingPhonenumberOutputRemoteData$outboundSchema))
            .optional(),
