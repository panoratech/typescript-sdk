...
export type UnifiedHrisTimesheetEntryOutput = {
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedHrisTimesheetEntryOutputFieldMappings | null | undefined;
    /**
...
/** @internal */
export const UnifiedHrisTimesheetEntryOutputFieldMappings$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedHrisTimesheetEntryOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisTimesheetEntryOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedHrisTimesheetEntryOutputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedHrisTimesheetEntryOutputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisTimesheetEntryOutputFieldMappings$outboundSchema;
...
/** @internal */
export const UnifiedHrisTimesheetEntryOutputRemoteData$outboundSchema: z.ZodType<
...
export namespace UnifiedHrisTimesheetEntryOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedHrisTimesheetEntryOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedHrisTimesheetEntryOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedHrisTimesheetEntryOutputRemoteData$outboundSchema;
...
> = z
    .object({
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedHrisTimesheetEntryOutputFieldMappings$inboundSchema))
            .optional(),
        ...
        modified_at: z
            ...
            .optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedHrisTimesheetEntryOutputRemoteData$inboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
export type UnifiedHrisTimesheetEntryOutput$Outbound = {
    ...
    field_mappings?: UnifiedHrisTimesheetEntryOutputFieldMappings$Outbound | null | undefined;
    id?: string | null | undefined;
    remote_id?: string | null | undefined;
    remote_created_at?: string | null | undefined;
    created_at?: string | undefined;
    modified_at?: string | undefined;
    remote_data?: UnifiedHrisTimesheetEntryOutputRemoteData$Outbound | null | undefined;
};
...
> = z
    .object({
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedHrisTimesheetEntryOutputFieldMappings$outboundSchema))
            .optional(),
        id: z.nullable(z.string()).optional(),
        ...
        modifiedAt: z
            ...
            .optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedHrisTimesheetEntryOutputRemoteData$outboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
