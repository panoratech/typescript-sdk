...
/** @internal */
export const TaxItem$inboundSchema: z.ZodType<TaxItem, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const TaxItem$outboundSchema: z.ZodType<TaxItem$Outbound, z.ZodTypeDef, TaxItem> = z
    .object({
        name: z.nullable(z.string()).optional(),
        amount: z.nullable(z.number()).optional(),
