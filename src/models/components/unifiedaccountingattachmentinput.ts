...
export type UnifiedAccountingAttachmentInput = {
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedAccountingAttachmentInputFieldMappings | null | undefined;
};

/** @internal */
export const UnifiedAccountingAttachmentInputFieldMappings$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedAccountingAttachmentInputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedAccountingAttachmentInputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedAccountingAttachmentInputFieldMappings$inboundSchema;
    /** @deprecated use `UnifiedAccountingAttachmentInputFieldMappings$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingAttachmentInputFieldMappings$outboundSchema;
...
> = z
    .object({
        ...
        field_mappings: z
            .nullable(z.lazy(() => UnifiedAccountingAttachmentInputFieldMappings$inboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
export type UnifiedAccountingAttachmentInput$Outbound = {
    ...
    field_mappings?: UnifiedAccountingAttachmentInputFieldMappings$Outbound | null | undefined;
};
...
> = z
    .object({
        ...
        fieldMappings: z
            .nullable(z.lazy(() => UnifiedAccountingAttachmentInputFieldMappings$outboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
