 ...
 */
export enum UnifiedAccountingIncomestatementOutputCurrency {
    Aed = "AED",
    Afn = "AFN",
    All = "ALL",
    Amd = "AMD",
...
export type UnifiedAccountingIncomestatementOutput = {
     ...
     * The currency used in the income statement
     */
    currency?: UnifiedAccountingIncomestatementOutputCurrency | null | undefined;
    /**
     ...
     * The custom field mappings of the object between the remote 3rd party & Panora
     */
    fieldMappings?: UnifiedAccountingIncomestatementOutputFieldMappings | null | undefined;
    /**
     ...
     * The remote data of the income statement in the context of the 3rd Party
     */
    remoteData?: UnifiedAccountingIncomestatementOutputRemoteData | null | undefined;
    /**
...
/** @internal */
export const UnifiedAccountingIncomestatementOutputCurrency$inboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingIncomestatementOutputCurrency
> = z.nativeEnum(UnifiedAccountingIncomestatementOutputCurrency);

/** @internal */
export const UnifiedAccountingIncomestatementOutputCurrency$outboundSchema: z.ZodNativeEnum<
    typeof UnifiedAccountingIncomestatementOutputCurrency
 ...
 */
export namespace UnifiedAccountingIncomestatementOutputCurrency$ {
    /** @deprecated use `UnifiedAccountingIncomestatementOutputCurrency$inboundSchema` instead. */
    export const inboundSchema = UnifiedAccountingIncomestatementOutputCurrency$inboundSchema;
    /** @deprecated use `UnifiedAccountingIncomestatementOutputCurrency$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingIncomestatementOutputCurrency$outboundSchema;
}

/** @internal */
export const UnifiedAccountingIncomestatementOutputFieldMappings$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedAccountingIncomestatementOutputFieldMappings$outboundSchema: z.ZodType<
...
export namespace UnifiedAccountingIncomestatementOutputFieldMappings$ {
    ...
    export const inboundSchema = UnifiedAccountingIncomestatementOutputFieldMappings$inboundSchema;
    ...
    export type Outbound = UnifiedAccountingIncomestatementOutputFieldMappings$Outbound;
}

/** @internal */
export const UnifiedAccountingIncomestatementOutputRemoteData$inboundSchema: z.ZodType<
...
/** @internal */
export const UnifiedAccountingIncomestatementOutputRemoteData$outboundSchema: z.ZodType<
...
export namespace UnifiedAccountingIncomestatementOutputRemoteData$ {
    ...
    export const inboundSchema = UnifiedAccountingIncomestatementOutputRemoteData$inboundSchema;
    /** @deprecated use `UnifiedAccountingIncomestatementOutputRemoteData$outboundSchema` instead. */
    export const outboundSchema = UnifiedAccountingIncomestatementOutputRemoteData$outboundSchema;
    /** @deprecated use `UnifiedAccountingIncomestatementOutputRemoteData$Outbound` instead. */
    export type Outbound = UnifiedAccountingIncomestatementOutputRemoteData$Outbound;
}
...
> = z
    .object({
        ...
        currency: z
            .nullable(UnifiedAccountingIncomestatementOutputCurrency$inboundSchema)
            .optional(),
        start_period: z
            .nullable(
                z
        ...
        field_mappings: z
            .nullable(
                z.lazy(() => UnifiedAccountingIncomestatementOutputFieldMappings$inboundSchema)
            )
            .optional(),
        id: z.nullable(z.string()).optional(),
        remote_id: z.nullable(z.string()).optional(),
        remote_data: z
            .nullable(z.lazy(() => UnifiedAccountingIncomestatementOutputRemoteData$inboundSchema))
            .optional(),
        created_at: z
            .nullable(
                z
...
export type UnifiedAccountingIncomestatementOutput$Outbound = {
    ...
    remote_data?: UnifiedAccountingIncomestatementOutputRemoteData$Outbound | null | undefined;
...
> = z
    .object({
        name: z.nullable(z.string()).optional(),
        currency: z
            .nullable(UnifiedAccountingIncomestatementOutputCurrency$outboundSchema)
            .optional(),
        ...
        fieldMappings: z
            .nullable(
                z.lazy(() => UnifiedAccountingIncomestatementOutputFieldMappings$outboundSchema)
            )
            .optional(),
        id: z.nullable(z.string()).optional(),
        remoteId: z.nullable(z.string()).optional(),
        remoteData: z
            .nullable(z.lazy(() => UnifiedAccountingIncomestatementOutputRemoteData$outboundSchema))
            .optional(),
