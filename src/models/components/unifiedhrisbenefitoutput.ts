...
export namespace UnifiedHrisBenefitOutputFieldMappings$ {
  ...
  export const inboundSchema =
    UnifiedHrisBenefitOutputFieldMappings$inboundSchema;
  /** @deprecated use `UnifiedHrisBenefitOutputFieldMappings$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedHrisBenefitOutputFieldMappings$outboundSchema;
...
export namespace UnifiedHrisBenefitOutputRemoteData$ {
  ...
  export const outboundSchema =
    UnifiedHrisBenefitOutputRemoteData$outboundSchema;
...
> = z.object({
  ...
  field_mappings: z.nullable(
    z.lazy(() => UnifiedHrisBenefitOutputFieldMappings$inboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remote_id: z.nullable(z.string()).optional(),
  remote_data: z.nullable(
    z.lazy(() => UnifiedHrisBenefitOutputRemoteData$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  fieldMappings: z.nullable(
    z.lazy(() => UnifiedHrisBenefitOutputFieldMappings$outboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remoteId: z.nullable(z.string()).optional(),
  remoteData: z.nullable(
    z.lazy(() => UnifiedHrisBenefitOutputRemoteData$outboundSchema),
  ).optional(),
