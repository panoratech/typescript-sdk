...
export namespace UnifiedHrisPaygroupOutputFieldMappings$ {
  ...
  export const inboundSchema =
    UnifiedHrisPaygroupOutputFieldMappings$inboundSchema;
  /** @deprecated use `UnifiedHrisPaygroupOutputFieldMappings$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedHrisPaygroupOutputFieldMappings$outboundSchema;
...
export namespace UnifiedHrisPaygroupOutputRemoteData$ {
  ...
  export const inboundSchema =
    UnifiedHrisPaygroupOutputRemoteData$inboundSchema;
  /** @deprecated use `UnifiedHrisPaygroupOutputRemoteData$outboundSchema` instead. */
  export const outboundSchema =
    UnifiedHrisPaygroupOutputRemoteData$outboundSchema;
...
> = z.object({
  ...
  field_mappings: z.nullable(
    z.lazy(() => UnifiedHrisPaygroupOutputFieldMappings$inboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remote_id: z.nullable(z.string()).optional(),
  remote_data: z.nullable(
    z.lazy(() => UnifiedHrisPaygroupOutputRemoteData$inboundSchema),
  ).optional(),
...
> = z.object({
  ...
  fieldMappings: z.nullable(
    z.lazy(() => UnifiedHrisPaygroupOutputFieldMappings$outboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  remoteId: z.nullable(z.string()).optional(),
  remoteData: z.nullable(
    z.lazy(() => UnifiedHrisPaygroupOutputRemoteData$outboundSchema),
  ).optional(),
